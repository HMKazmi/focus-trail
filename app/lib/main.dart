...
void main() async {
  ...
  try {
    ...
    await openHiveBoxes();
    AppLogger.success('All Hive boxes opened successfully', module: 'Bootstrap');
    
    AppLogger.success('App initialization complete! 🎉', module: 'Bootstrap');
    AppLogger.separator();
  } catch (e, stack) {
    AppLogger.error('Failed to initialize app', module: 'Bootstrap', error: e, stackTrace: stack);
    rethrow;
  }

  runApp(
    const ProviderScope(
      child: ProductivityTrackerApp(),
    ),
  );
}
